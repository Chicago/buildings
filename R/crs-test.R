...
# ogrInfo(dsn = "data/geojson/tracts.geojson")

# Source: "data/geojson/tracts.geojson", layer: "OGRGeoJSON"
# Driver: GeoJSON; number of rows: 801 
# Feature type: wkbPolygon with 2 dimensions
# Extent: (-87.94025 41.64429) - (-87.52366 42.02392)
# CRS: +proj=longlat +datum=WGS84 +no_defs  

# ogrInfo(dsn = "gitexclude/Buildings.geojson")

# Source: "gitexclude/Buildings.geojson", layer: "OGRGeoJSON"
...
# ogrInfo(dsn = "gitexclude/parcels.geojson")

# Source: "gitexclude/parcels.geojson", layer: "OGRGeoJSON"
# Driver: GeoJSON; number of rows: 1414707 
# Feature type: wkbPolygon with 2 dimensions
# Extent: (-88.26363 41.46971) - (-87.52453 42.15429)
# CRS: +proj=longlat +datum=WGS84 +no_defs 

tracts <- readOGR("data/geojson/tracts.geojson", stringsAsFactors = FALSE)
buildings <- readOGR("gitexclude/buildings.geojson", stringsAsFactors = FALSE)
taxShapes <- readOGR("gitexclude/parcels.geojson", stringsAsFactors = FALSE)
